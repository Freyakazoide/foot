...
def main():
    ...
    cursor.executescript("""
        ...
        CREATE TABLE league_tables (competition_id INTEGER, club_id INTEGER, position INTEGER, played INTEGER, wins INTEGER, draws INTEGER, losses INTEGER, goals_for INTEGER, goals_against INTEGER, goal_difference INTEGER, points INTEGER, PRIMARY KEY (competition_id, club_id));
